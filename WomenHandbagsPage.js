...
function WomenHandbagsPage() {
  ...
  // Get women handbags products from global productDetails (IDs 1001-1029)
  const womenHandbagsProducts = productDetails.filter(p => p.id >= 1001 && p.id <= 1029);
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Women > Handbags in drawer
      />
