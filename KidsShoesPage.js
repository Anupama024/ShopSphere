...
function KidsShoesPage() {
  ...
  // Get kids shoes products from global productDetails (IDs 1201-1222)
  const kidsShoesProducts = productDetails.filter(p => p.type === 'shoes');
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Kids > Shoes in drawer
      />
