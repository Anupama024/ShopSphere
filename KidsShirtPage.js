...
function KidsShirtPage() {
  ...
  // Get kids shirts products from global productDetails (IDs or category for kids shirts)
  const kidsShirtProducts = productDetails.filter(p => p.category === 'KidsShirt');
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Kids > Shirts in drawer
      />
