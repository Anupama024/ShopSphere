...
function WomenJeansPage() {
  ...
  // Get women jeans products from global productDetails (IDs 701-719)
  const womenJeansProducts = productDetails.filter(p => p.id >= 701 && p.id <= 719);
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Women > Jeans in drawer
      />
