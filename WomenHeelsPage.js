...
function WomenHeelsPage() {
  ...
  // Get women heels products from global productDetails (IDs 901-938)
  const womenHeelsProducts = productDetails.filter(p => p.id >= 901 && p.id <= 938);
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Women > Shoes in drawer
      />
