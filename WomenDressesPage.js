...
function WomenDressesPage() {
  ...
  // Get dresses products from global productDetails (IDs 1-21)
  const dressesProducts = productDetails.filter(p => p.id >= 1 && p.id <= 21);
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#fafafa' }}>
      <GlobalAppBarDrawer
        ...
        // Navigation for Women > Dresses in drawer
      />
